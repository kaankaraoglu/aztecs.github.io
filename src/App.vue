  ...
  <div class="app">
    ...
    <nav class="nav">
      ...
      <div :class="['nav-links', { open: menuOpen }]">
        ...
        <RouterLink class="nav-link" to="/wow" @click="menuOpen = false">World of Warcraft</RouterLink>
        ...
        <svg class="discord-svg" xmlns="http://www.w3.org/2000/svg" height="1.2em" viewBox="0 -28.5 256 256"
          preserveAspectRatio="xMidYMid" @click="openDiscordInvite">
          <g>
            <path class="discord-svg-path"
