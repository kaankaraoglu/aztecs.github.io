 ...
 * This endpoint returns per-boss encountersDefeated data per guild.
 *
 * @param {string} raidSlug
 * @param {string} difficulty
 * @returns {Promise<Set<string>>} Set of defeated encounter slugs
 */
 ...
 * per-boss kill data from the raid-rankings endpoint.
 *
