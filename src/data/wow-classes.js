...
/** @typedef {{ name: string, description: string, icon: string, classes: string[], category: 'throughput' | 'utility' }} BuffDef */
...
export const RAID_BUFFS = {
  ...
  atrophicPoison: {
    ...
    icon: 'ability_rogue_atrophicpoison',
    classes: ['rogue'],
    category: 'throughput',
  },
  battleShout: {
  ...
  gorefiendsGrasp: {
    ...
    icon: 'ability_deathknight_aaborofunholy',
    classes: ['deathKnight'],
    category: 'utility',
  },
  healthstone: {
